...
const recipeCategories = [
  { name: "Breakfast", image: require("../assets/categories/breakfast.png") },
  { name: "Lunch", image: require("../assets/categories/lunch.png") },
  { name: "Dinner", image: require("../assets/categories/dinner.png") },
  { name: "Dessert", image: require("../assets/categories/dessert.png") },
  { name: "Snack", image: require("../assets/categories/snack.png") },
  { name: "More", image: require("../assets/categories/more.png") },
];
...
const styles = StyleSheet.create({
  ...
  categoryCard: {
    width: "31%",
    backgroundColor: "#C4725D",  // Terracotta color
    borderRadius: 16,
    paddingVertical: 14,
    paddingHorizontal: 8,
    alignItems: "center",
