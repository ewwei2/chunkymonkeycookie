...
export default function Pantry() {
    ...
    // returns ture id item expires within 3 days
    ...
    // create new item -> add to items array
    const addItem = () => {
        if (!name) return;
    ...
    // sort items: in season, expiring soon, fresh, expired
    ...
    // swift left -> edit and delete buttons
    ...
    // open edit modal pre-filled with items data
        ...
        <View style={styles.overlay}>
          <View style={styles.modalBox}>
            ...
            <Picker selectedValue={storageLocation} onValueChange={setStorageLocation} style={styles.picker}>
              ...
              <Picker.Item label="🗄️ Dry Pantry" value="Dry Pantry" />
              <Picker.Item label="🧊 Fridge" value="Fridge" />
              <Picker.Item label="❄️ Freezer" value="Freezer" />
            </Picker>
...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, borderWidth: 1, borderColor: '#ccc', borderRadius: 24, padding: 10, paddingLeft: 16 },
  addButton: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#ccc', borderRadius: 22, width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  addButtonText: { fontSize: 24, color: '#333' },
  itemCard: { borderWidth: 1, borderColor: '#eee', borderRadius: 12, padding: 12, marginBottom: 10, backgroundColor: '#fff' },
